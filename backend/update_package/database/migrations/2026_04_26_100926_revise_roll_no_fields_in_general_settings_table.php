...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('general_settings', function (Blueprint $table) {
            ...
            // Add revised Roll No fields
            $table->string('roll_no_prefix')->nullable();
            $table->integer('roll_no_digit')->default(4);
            $table->string('roll_no_start_from')->nullable();
        });
    }
    ...
    {
        Schema::table('general_settings', function (Blueprint $table) {
            $table->dropColumn(['roll_no_prefix', 'roll_no_digit', 'roll_no_start_from']);
