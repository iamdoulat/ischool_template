            ...
            <div className="container mx-auto pl-3 pr-5 sm:px-6 md:px-8 relative z-10">
              <div className="max-w-4xl space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-1000">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-6 max-w-full">
                  <Button asChild size="lg" className="text-base font-bold px-6 sm:px-10 h-14 rounded-full shadow-lg hover:shadow-primary/20 hover:scale-105 transition-all duration-300 w-full sm:w-auto">
              ...
              <div className="p-8 space-y-6 bg-white overflow-y-auto max-h-[65vh]">
                ...
                {viewNotice.is_published !== undefined && (
                  <div className="flex items-center gap-2">
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${viewNotice.is_published ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'
                      }`}>
