                ...
                <DialogContent className="max-w-4xl p-0 rounded-2xl overflow-hidden border-none shadow-2xl bg-white">
                        ...
                        <div className="space-y-1.5">
                            <div className="flex items-center justify-between">
                                ...
                                <Button
                                    ...
                                    className="h-6 px-2.5 text-[10px] font-bold text-gray-500 hover:text-[#6366f1] uppercase rounded-full hover:bg-gray-100"
                                >
                                    {showHtml ? t("rich_text") : "HTML"}
                                </Button>
                            </div>
                            <div className="min-h-[220px] border border-gray-200 rounded-xl overflow-hidden shadow-2xs">
                                {showHtml ? (
                                    <textarea
                                        value={form.content}
                                        onChange={(e) => setForm({ ...form, content: e.target.value })}
                                        className="w-full min-h-[220px] p-3 text-xs font-mono border-0 focus:outline-none resize-y"
                                        placeholder={t("your_html_content_here")}
                                    />
                                ) : (
                                    <ReactQuill
                                        theme="snow"
                    ...
                    <DialogFooter className="p-4 px-6 bg-gray-50/80 border-t border-gray-100 flex sm:justify-between items-center gap-3">
                        ...
                        >
                            ...
                            {editingId ? t("update") : t("save_page")}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
