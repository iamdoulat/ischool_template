...
import { 
    ...
    FileText, FileCode, Printer, Columns, Video, Users
} from "lucide-react";
...
interface ClassReport {
    ...
    staff?: { id?: number; name: string; last_name: string; role?: string; employee_id?: string };
...
export default function LiveClassesReportPage() {
    ...
    const handleOpenJoinList = (item: ClassReport) => {
        ...
        if (item.staff) {
            list.push({
                ...
                id: item.staff.employee_id || item.staff.id || item.created_by,
    ...
    const handleCopy = () => {
        ...
        const text = reports.map(i => `${i.title}\t${i.description || ""}\t${i.date_time}\t${i.creator?.name || ""}\t${i.total_join || 0}\t${i.status}`).join('\n');
    ...
    const handleExportExcel = () => {
        ...
        XLSX.writeFile(wb, "live_classes_report.xlsx");
    ...
    const handleExportCSV = () => {
        ...
        link.setAttribute("download", "live_classes_report.csv");
    ...
    const handleExportPDF = () => {
        ...
        autoTable(doc, {
            head: [[t("class_title"), t("description"), t("date_time"), t("created_by"), t("total_join"), t("status")]],
            body: reports.map(i => [
                i.title || "—",
                i.description || "—",
                i.date_time || "—",
        ...
        doc.save("live_classes_report.pdf");
        ...
        <div className="space-y-6">
            ...
            <div className="rounded-xl border-[0.5px] border-gray-300 dark:border-zinc-800 shadow-[0_4px_24px_rgb(0,0,0,0.08)] bg-card/50 backdrop-blur-sm overflow-hidden">
                ...
                <div className="p-6 bg-white dark:bg-card/40">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                        ...
                        {/* Search Button moved to marked 3rd position in the row */}
            ...
            <div className="rounded-xl border-[0.5px] border-gray-300 dark:border-zinc-800 shadow-[0_4px_24px_rgb(0,0,0,0.08)] bg-card/50 backdrop-blur-sm overflow-hidden min-h-[250px]">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-5 py-4 bg-gradient-to-r from-[#FFF5E7] to-[#EFF0FD] dark:from-zinc-900 dark:to-zinc-950 dark:border-b dark:border-zinc-800">
                    ...
                    {/* Row control + Action icons always displayed in the header */}
                ...
                <div className="p-5 bg-white dark:bg-card/40 space-y-4">
                    ...
                    {/* Footer Pagination always present */}
