...
export default function ItemCategoryPage() {
    ...
    const exportData = categories.map(c => ({
        [t("item_category")]: c.item_category || "—",
    ...
    const handleExportExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, t("categories") || "Categories");
    ...
    const handleExportPDF = () => {
        ...
        const doc = new jsPDF();
        doc.text(t("item_category_list"), 14, 15);
        autoTable(doc, {
            head: [[t("item_category"), t("description")]],
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="h-fit border-[0.5px] border-gray-300 dark:border-zinc-800 shadow-[0_4px_24px_rgb(0,0,0,0.08)] bg-card/50 backdrop-blur-sm overflow-hidden pt-0">
                    <CardHeader className="flex flex-row items-center gap-2.5 space-y-0 px-5 py-4 bg-gradient-to-r from-[#FFF5E7] to-[#EFF0FD] dark:from-zinc-900 dark:to-zinc-950 dark:border-b dark:border-zinc-800">
                        ...
                        <div className="min-w-0">
                            <CardTitle className="text-base font-bold tracking-tight text-slate-800 dark:text-slate-100 leading-none">{isEditing ? t("edit_item_category") : t("add_item_category")}</CardTitle>
                            <p className="text-[11px] text-gray-500 dark:text-gray-400 mt-1">{isEditing ? t("update_selected_category") : t("create_new_category")}</p>
                        </div>
                    </CardHeader>
                ...
                <Card className="lg:col-span-2 border-[0.5px] border-gray-300 dark:border-zinc-800 shadow-[0_4px_24px_rgb(0,0,0,0.08)] bg-card/50 backdrop-blur-sm overflow-hidden pt-0">
                    <CardHeader className="flex flex-row items-center gap-2.5 space-y-0 px-5 py-4 bg-gradient-to-r from-[#FFF5E7] to-[#EFF0FD] dark:from-zinc-900 dark:to-zinc-950 dark:border-b dark:border-zinc-800">
                        ...
                        <div className="min-w-0">
                            <CardTitle className="text-base font-bold tracking-tight text-slate-800 dark:text-slate-100 leading-none">{t("item_category_list")}</CardTitle>
                            <p className="text-[11px] text-gray-500 dark:text-gray-400 mt-1">{toLocaleNumber(totalCount, shortCode)} {t("categories")}</p>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-4">
                                ...
                                <TableBody>
                                    {loading ? (
                                        ...
                                        <TableRow key={cat.id} className="text-xs hover:bg-indigo-50/40 hover:shadow-sm hover:z-10 relative transition-all duration-300 cursor-pointer">
                                            ...
                                            <TableCell className="py-3 text-gray-400 italic">{cat.description || "—"}</TableCell>
