...
const incomeHeadData: IncomeHeadRecord[] = [
    { id: "1", incomeHead: "Donation", description: "" },
    { id: "2", incomeHead: "Rent", description: "" },
    { id: "3", incomeHead: "Miscellaneous", description: "" },
    { id: "4", incomeHead: "Book Sale", description: "" },
    { id: "5", incomeHead: "Uniform Sale", description: "" },
    { id: "6", incomeHead: "Miscellaneous1", description: "" },
];
...
export default function IncomeHeadPage() {
    ...
    const filteredData = incomeHeadData.filter((item) =>
        ...
        <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-lg shadow-sm border p-4 space-y-4 h-fit">
                    <h2 className="text-lg font-medium text-gray-800 border-b pb-2">Add Income Head</h2>
                ...
                <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border p-4 space-y-4">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500 font-medium pt-2">
                        <div>
                            Showing 1 to {filteredData.length} of {incomeHeadData.length} entries
                        </div>
