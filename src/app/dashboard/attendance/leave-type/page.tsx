...
export default function LeaveTypePage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast("error", err.response?.data?.message || t("failed_to_save_leave_type"));
        }
    };
    ...
    // Export Functions
    const exportToExcel = () => {
        const ws = XLSX.utils.json_to_sheet(leaveTypes.map(lt => ({ [t("leave_type")]: lt.name })));
    ...
    const total = filteredLeaveTypes.length;
