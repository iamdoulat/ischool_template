...
// Mock Data
const initialCaptchaSettings = [
    { id: 1, name: "User login", active: false },
    { id: 2, name: "Login", active: false },
    { id: 3, name: "Admission", active: false },
    { id: 4, name: "Complain", active: false },
    { id: 5, name: "Contact Us", active: false },
    { id: 6, name: "Guest login and signup", active: false },
];

export default function CaptchaSettingPage() {
    const [settings, setSettings] = useState(initialCaptchaSettings);
        ...
        <div className="p-4 bg-gray-50/10 min-h-screen font-sans space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden flex flex-col">
                ...
                <div className="px-4 py-3 border-b border-gray-50">
                    <h1 className="text-[14px] font-medium text-gray-700">Captcha Setting</h1>
                </div>
                ...
                <div className="flex-1 overflow-auto bg-white p-4">
                    ...
                    <div className="flex items-center justify-between pt-4">
                        <p className="text-[10px] text-gray-500 font-medium">
                            Showing 1 to {filteredSettings.length} of {settings.length} entries
                        </p>
                        <div className="flex items-center gap-1">
