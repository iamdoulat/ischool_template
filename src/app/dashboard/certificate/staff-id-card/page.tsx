...
const mockTemplates: StaffIDCardTemplate[] = [
    { id: "1", title: "Sample Staff ID Card", backgroundImage: "staff_bg_h.png", designType: "Horizontal" },
    { id: "2", title: "Sample Staff ID Card Vertical", backgroundImage: "staff_bg_v.png", designType: "Vertical" },
];

const toggleFields = [
    { label: "Staff Name", id: "staff_name" },
    { label: "Staff ID", id: "staff_id" },
    { label: "Designation", id: "designation" },
    { label: "Department", id: "department" },
    { label: "Father Name", id: "father_name" },
    { label: "Mother Name", id: "mother_name" },
    { label: "Date Of Joining", id: "joining_date" },
    { label: "Current Address", id: "address" },
    ...
    return (
        <div className="p-4 space-y-4 bg-gray-50/10 min-h-screen font-sans text-xs">
            <div className="flex flex-col lg:flex-row gap-6">
                {/* Left Section: Add Staff ID Card Form */}
                <div className="w-full lg:w-[450px]">
                    <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                        <div className="p-4 border-b border-gray-100">
                            <h2 className="text-sm font-medium text-gray-800 tracking-tight">Add Staff ID Card</h2>
                        </div>
                ...
                {/* Right Section: Staff ID Card List */}
                <div className="flex-1 min-w-0">
                    <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 space-y-4 overflow-hidden">
                        <h2 className="text-sm font-medium text-gray-800 tracking-tight">Staff ID Card List</h2>
                                        ...
                                        <TableRow key={template.id} className="text-[11px] border-b border-gray-50 hover:bg-gray-50/30 transition-colors whitespace-nowrap">
                                            ...
                                            <TableCell className="py-3 px-4">
                                                <div className="h-10 w-14 bg-gray-100 rounded border border-gray-200 flex items-center justify-center group cursor-pointer hover:bg-gray-200 transition-colors relative">
                                                    <ImageIcon className="h-5 w-5 text-red-800 opacity-60" />
                                                </div>
                                            </TableCell>
