...
const mockStudents: Student[] = [
    ...
    { admissionNo: "18001", name: "Edward Thomas", class: "Class 1(A)", fatherName: "Olivier Thomas", dob: "10/24/2013", gender: "Male", category: "General", mobile: "8006785675" },
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Select>
                            <SelectTrigger className="h-8 border-gray-200 text-[11px] focus:ring-indigo-500 rounded shadow-none">
                                <SelectValue placeholder="sample transfer certificate" />
                            </SelectTrigger>
                            <SelectContent>
                                <SelectItem value="tc">sample transfer certificate</SelectItem>
                                <SelectItem value="mc">merit certificate</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                </div>
