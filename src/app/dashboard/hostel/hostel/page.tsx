...
const mockHostels: HostelMaster[] = [
    { id: "1", name: "Boys Hostel 101", type: "Boys", address: "School Campus", intake: "200" },
    { id: "2", name: "Boys Hostel 102", type: "Boys", address: "School Campus", intake: "200" },
    { id: "3", name: "Girls Hostel 103", type: "Girls", address: "School Campus", intake: "150" },
    { id: "4", name: "Girls Hostel 104", type: "Girls", address: "School Campus", intake: "150" },
    { id: "5", name: "hostel", type: "Boys", address: "", intake: "456" },
];
                ...
                <div className="flex-1 min-w-0">
                    <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 space-y-4 overflow-hidden">
                                ...
                                <TableBody>
                                    {filteredHostels.map((hostel) => (
                                        <TableRow key={hostel.id} className="text-[11px] border-b border-gray-50 hover:bg-gray-50/30 transition-colors whitespace-nowrap">
                                            ...
                                            <TableCell className="py-3 text-gray-500">{hostel.type}</TableCell>
                        ...
                        <div className="flex items-center justify-between text-[10px] text-gray-500 font-medium pt-2 border-t border-gray-50">
                            <div>
                                Showing 1 to {filteredHostels.length} of {mockHostels.length} entries
                            </div>
