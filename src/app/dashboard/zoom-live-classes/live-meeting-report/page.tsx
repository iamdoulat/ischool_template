...
export default function LiveMeetingReportPage() {
    ...
    const handleCopy = () => {
        ...
        const text = reports.map(i => `${i.title}\t${i.description || ""}\t${i.date_time}\t${i.api_used}\t${i.creator?.name || t("self")}\t${i.total_join || 0}\t${i.status}`).join('\n');
    ...
    const handleExportExcel = () => {
        ...
        XLSX.writeFile(wb, "zoom_live_meeting_report.xlsx");
    ...
    const handleExportCSV = () => {
        ...
        link.setAttribute("download", "zoom_live_meeting_report.csv");
    ...
    const handleExportPDF = () => {
        ...
        doc.save("zoom_live_meeting_report.pdf");
            ...
            <div className="rounded-xl border-[0.5px] border-gray-300 dark:border-zinc-800 shadow-[0_4px_24px_rgb(0,0,0,0.08)] bg-card/50 backdrop-blur-sm overflow-hidden">
                <div className="flex flex-row items-center gap-2.5 px-5 py-4 bg-gradient-to-r from-[#FFF5E7] to-[#EFF0FD] dark:from-zinc-900 dark:to-zinc-950 dark:border-b dark:border-zinc-800">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-[11px] text-gray-500 dark:text-gray-400 mt-1">{t("view_all_hosted_zoom_meetings_and_attendance")}</p>
                    </div>
                </div>
            </div>

            {/* Inner Content Card Area */}
            <div className="bg-white dark:bg-card/40 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-800 p-5 space-y-4 overflow-hidden min-h-[450px]">
