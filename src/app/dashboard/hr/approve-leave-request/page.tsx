    ...
    return (
        <div className="p-4 space-y-6 bg-gray-50/10 min-h-screen font-sans">
            ...
            <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
                <DialogContent className="sm:max-w-[500px] p-0 font-sans border-0 shadow-2xl overflow-hidden gap-0 rounded-xl">
                    ...
                    {selectedRequest && (
                        <div className="p-6 space-y-6">
                            ...
                            <div className="pt-4 border-t border-gray-100">
                                ...
                                <div className="text-[12px] text-gray-700 bg-gray-50 p-4 rounded-xl border border-gray-100 leading-relaxed italic shadow-inner">
                            ...
                            <div className="pt-4 border-t border-gray-100 space-y-3">
                                ...
                                <Textarea 
                                    ...
                                    className="text-xs resize-none h-24 border-gray-200 rounded-xl shadow-none focus:ring-1 focus:ring-indigo-500"
