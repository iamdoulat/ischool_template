                                            ...
                                            <TableCell className="py-3 pr-6 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    <Button 
                                                        ...
                                                        size="icon" 
                                                        className="h-7 w-7 rounded bg-rose-50 hover:bg-rose-500 text-rose-500 hover:text-white transition-all border border-rose-100 opacity-0 group-hover:opacity-100"
                                                    >
            ...
            <AlertDialog open={deleteId !== null} onOpenChange={(open) => !open && setDeleteId(null)}>
                <AlertDialogContent className="rounded-lg">
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This action cannot be undone. This will permanently delete the student record from the CV registry.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        <AlertDialogCancel className="rounded-md">Cancel</AlertDialogCancel>
                        <AlertDialogAction onClick={executePurge} className="bg-rose-500 hover:bg-rose-600 rounded-md">
                            Delete
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
