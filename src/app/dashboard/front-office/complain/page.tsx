...
const complaintData = [
    { id: "363", type: "Transport", name: "Abhishek Rao", phone: "905674833", date: "01/26/2026" },
    { id: "362", type: "Transport", name: "Utkarsh Srivastava", phone: "980456452", date: "01/22/2026" },
    { id: "361", type: "Sports", name: "Nelson", phone: "908783452", date: "01/17/2026" },
    { id: "360", type: "Teacher", name: "Bella McCallum", phone: "907845634", date: "01/12/2026" },
    { id: "359", type: "Study", name: "Sweta Sharma", phone: "890867563", date: "01/06/2026" },
];
                ...
                <div className="md:col-span-4">
                    <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-card/50 backdrop-blur-sm">
                        <CardHeader className="border-b border-muted/50 pb-4">
                            <CardTitle className="text-xl font-bold tracking-tight text-slate-800">Add Complain</CardTitle>
                        </CardHeader>
                        <CardContent className="p-6 space-y-4">
                            <div className="space-y-1.5 group">
                                ...
                                <div className="relative">
                                    <select className="flex h-10 w-full rounded-lg border border-muted/50 bg-muted/30 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 appearance-none cursor-pointer group-hover:border-indigo-200 transition-colors font-medium text-slate-700">
                                    ...
                                    <tbody className="divide-y divide-muted/30">
                                        {complaintData.map((item) => (
                                            <tr key={item.id} className="hover:bg-muted/10 transition-colors group">
                                                ...
                                                <Td className="text-slate-600 font-medium">{item.type}</Td>
