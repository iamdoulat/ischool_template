...
const callLogData = [
    { id: "1", name: "Exam Center Office", phone: "644487657", date: "01/21/2026", nextFollowUp: "01/28/2026", callType: "Incoming" },
    { id: "2", name: "Cleaning Services", phone: "905677846", date: "01/27/2026", nextFollowUp: "01/29/2026", callType: "Outgoing" },
    { id: "3", name: "Telephone Office", phone: "809678546", date: "01/26/2026", nextFollowUp: "01/29/2026", callType: "Outgoing" },
    { id: "4", name: "Staff Health Checkup", phone: "980567453", date: "01/22/2026", nextFollowUp: "01/24/2026", callType: "Outgoing" },
    { id: "5", name: "Electricity Office", phone: "899056734", date: "01/17/2026", nextFollowUp: "01/19/2026", callType: "Incoming" },
];
                ...
                <div className="md:col-span-4">
                    <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-card/50 backdrop-blur-sm">
                        <CardHeader className="border-b border-muted/50 pb-4">
                            <CardTitle className="text-xl font-bold tracking-tight text-slate-800">Add Phone Call Log</CardTitle>
                        </CardHeader>
                            ...
                            <div className="space-y-3 group pb-2">
                                ...
                                <div className="flex gap-6 ml-1">
                                    <label className="flex items-center gap-2 cursor-pointer group/item">
                                        <input type="radio" name="callType" className="w-4 h-4 accent-[#008489]" defaultChecked />
                                        <span className="text-sm font-medium text-slate-600 group-hover/item:text-slate-900 transition-colors">Incoming</span>
                                    </label>
                                    <label className="flex items-center gap-2 cursor-pointer group/item">
                                        <input type="radio" name="callType" className="w-4 h-4 accent-[#008489]" />
                    ...
                    <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-card/50 backdrop-blur-sm">
                        ...
                        <CardContent className="p-6">
                                    ...
                                    <tbody className="divide-y divide-muted/30">
                                        {callLogData.map((item) => (
                                            <tr key={item.id} className="hover:bg-muted/10 transition-colors group">
                                                ...
                                                <Td className="text-slate-600 font-medium">{item.callType}</Td>
                            ...
                            <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground font-medium">
                                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em]">Showing 1 to 5 of 15 entries</p>
                                <div className="flex items-center gap-2">
