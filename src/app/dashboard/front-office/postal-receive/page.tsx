...
const receiveData = [
    { id: "1", from: "Blind Literature Program", ref: "RFN078675", to: "Blind Literature Program", date: "01/19/2026" },
    { id: "2", from: "Blind Literature Program", ref: "RFN4867", to: "Blind Literature Program", date: "01/26/2026" },
    { id: "3", from: "Staff Health Checkup", ref: "RFN0890678", to: "Staff Health Checkup", date: "01/22/2026" },
    { id: "4", from: "Books deliver in School", ref: "RFN87945", to: "Books deliver in School", date: "01/17/2026" },
    { id: "5", from: "Auditor General Rule-Book", ref: "RFN89654", to: "Auditor General Rule-Book", date: "01/12/2026" },
];
                ...
                <div className="md:col-span-4">
                    <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-card/50 backdrop-blur-sm">
                        <CardHeader className="border-b border-muted/50 pb-4">
                            <CardTitle className="text-xl font-bold tracking-tight text-slate-800">Add Postal Receive</CardTitle>
                        </CardHeader>
                                    ...
                                    <tbody className="divide-y divide-muted/30">
                                        {receiveData.map((item) => (
                                            <tr key={item.id} className="hover:bg-muted/10 transition-colors group">
                                                <Td className="font-semibold text-slate-700">{item.from}</Td>
                                                <Td className="text-slate-600 font-medium">{item.ref}</Td>
                                                <Td className="text-slate-600 font-medium">{item.to}</Td>
