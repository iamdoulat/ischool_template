...
// Skeleton component for recipient loading states
...
export default function SendEmailPage() {
    ...
    const handleTemplateChange = async (id: string) => {
        ...
        if (template) {
            ...
            if (template.attachment) {
                try {
                    const response = await api.get(`/communicate/email-templates/${template.id}/download-attachment`, {
                        responseType: 'blob'
                    });
    ...
    const executeSubmit = async () => {
        ...
        getRecipientsArray().forEach(r => data.append('recipients[]', r));
    ...
    return (
        <div className="p-4 space-y-4 bg-gray-50/10 min-h-screen font-sans">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Left Column: Compose Email Area */}
