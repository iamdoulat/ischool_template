        ...
        <div className="p-4 space-y-4 bg-gray-50/10 min-h-screen font-sans">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-2">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-gray-400 font-medium uppercase tracking-widest mt-0.5">{t("send_sms_subtitle") || "Bulk & Individual SMS Broadcast"}</p>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card className="border-[0.5px] border-gray-300 shadow-[0_4px_24px_rgb(0,0,0,0.08)] bg-card/50 backdrop-blur-sm overflow-hidden pt-0">
                        <CardHeader className="flex flex-row items-center gap-2.5 space-y-0 px-5 py-4 bg-gradient-to-r from-[#FFF5E7] to-[#EFF0FD]">
                            ...
                            <div>
                                <CardTitle className="text-base font-bold tracking-tight text-slate-800 leading-none">{t("compose_sms") || "Compose SMS"}</CardTitle>
                                <p className="text-[11px] text-gray-500 mt-1">{t("compose_sms_description") || "Draft SMS text message or choose from predefined templates"}</p>
                            </div>
                        </CardHeader>
                        <CardContent className="p-8 space-y-8 relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder={t("sms_title_placeholder") || "e.g. Exam Schedule Notification"}
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    placeholder={t("compose_sms_message_placeholder") || "Type your SMS message here..."}
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-white/80 backdrop-blur-md border border-gray-100 rounded-lg p-6 shadow-xl shadow-indigo-100/20 mt-4 sticky bottom-4 z-10">
                ...
                <div className="flex items-center gap-6">
                    ...
                    >
                        {submitting ? t("processing") : formData.send_type === 'now' ? t("confirm_and_send") : (t("schedule_sms") || t("schedule_message") || "Schedule SMS")}
                    </Button>
                </div>
            </div>
            ...
            <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
                <AlertDialogContent className="rounded-lg border-0 shadow-2xl">
                    <AlertDialogHeader>
                        <AlertDialogTitle className="text-xl font-bold text-gray-800">{t("confirm_sms_dispatch") || "Confirm SMS Dispatch"}</AlertDialogTitle>
