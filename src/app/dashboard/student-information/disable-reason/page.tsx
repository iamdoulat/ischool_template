...
const disableReasons = [
    { id: "1", reason: "Regular Absent" },
    { id: "2", reason: "Fees Not Paid" },
];
                ...
                <div className="md:col-span-4">
                    <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-card/50 backdrop-blur-sm">
                        <CardHeader className="border-b border-muted/50 pb-4">
                            <CardTitle className="text-xl font-bold tracking-tight text-slate-800">Add Disable Reason</CardTitle>
                        </CardHeader>
                    ...
                    <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-card/50 backdrop-blur-sm">
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground font-medium">
                                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em]">Showing 1 to 2 of 2 entries</p>
                                <div className="flex items-center gap-2">
