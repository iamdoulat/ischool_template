...
export default function StudentAdmissionPage() {
    ...
    const fetchAutoGeneratedIds = async (cId?: string, sId?: string) => {
        ...
        try {
            ...
            if (admData.auto_enabled !== false) setAutoAdmissionEnabled(true);
            if (rollData.auto_enabled !== false) setAutoRollEnabled(true);
            if (userData.auto_enabled !== false) {
    ...
    const fetchAdmissionNo = async () => {
        if (formData.school_class_id && formData.section_id) {
            fetchAutoGeneratedIds();
            return;
        }
        try {
    ...
    const fetchParentUsername = async (cId?: string, sId?: string) => {
        ...
        await fetchAutoGeneratedIds(cId, sId);
