...
export function AboutUsSection() {
    ...
    const schoolName = settings?.school_name || "iSchool Management System";
    const schoolSlogan = settings?.school_slogan || "Excellence in Education & Character Building";
    ...
    return (
        <div className="space-y-16 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                <div className="lg:col-span-6 relative">
                    ...
                    <div className="absolute -bottom-5 -right-4 sm:bottom-6 sm:-right-6 bg-gradient-to-r from-[#FF9800] to-[#6366F1] text-white p-4 sm:p-5 rounded-2xl shadow-xl flex items-center gap-3.5 backdrop-blur-md">
                        ...
                        <div>
                            ...
                            <span className="text-xs text-white/90 font-medium">Of Educational Excellence</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-6 space-y-5">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 text-xs font-bold uppercase tracking-wider border border-indigo-100 dark:border-indigo-900/50">
                        <Sparkles className="h-3.5 w-3.5" /> Welcome to {schoolName}
                    </div>

                    <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 dark:text-white leading-tight tracking-tight">
                        Empowering Minds, Inspiring Character, Shaping the Future.
                    </h2>

                    <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
                        At <strong className="text-slate-800 dark:text-white">{schoolName}</strong>, we provide a holistic learning environment where academic curiosity meets moral integrity. Our pedagogy nurtures critical thinking, creative innovation, and collaborative leadership.
                    </p>

                    <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                        With cutting-edge technology, certified passionate educators, and world-class athletic and arts facilities, we prepare each student to thrive in an ever-evolving global society.
                    </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition-shadow space-y-4">
                    ...
                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                        To inspire every student to realize their fullest intellectual, ethical, and athletic potential through engaging pedagogical methods, inclusive support, and real-world problem-solving.
                    </p>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition-shadow space-y-4">
                    ...
                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                        To stand as a benchmark educational sanctuary that cultivates empathetic leaders, ground-breaking researchers, and globally conscious citizens equipped to build a brighter tomorrow.
                    </p>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md transition-shadow space-y-4">
                    ...
                    <h3 className="text-xl font-extrabold text-slate-900 dark:text-white">Our Core Values</h3>
                    <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                        Integrity, Mutual Respect, Academic Excellence, Inclusivity, and Lifelong Curiosity. These pillars guide all student interactions, faculty dedication, and institutional governance.
                    </p>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white rounded-3xl p-8 sm:p-12 shadow-lg border border-slate-800">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-white/10">
                    <div className="space-y-1">
                        <span className="block text-3xl sm:text-5xl font-black text-amber-400">100%</span>
                        <p className="text-xs sm:text-sm text-slate-300 font-medium">Academic Pass Rate</p>
                    </div>
                    <div className="space-y-1 pt-6 md:pt-0">
                        <span className="block text-3xl sm:text-5xl font-black text-indigo-400">50+</span>
                        <p className="text-xs sm:text-sm text-slate-300 font-medium">Qualified Educators</p>
                    </div>
                    <div className="space-y-1 pt-6 md:pt-0">
                        <span className="block text-3xl sm:text-5xl font-black text-emerald-400">1,200+</span>
                        <p className="text-xs sm:text-sm text-slate-300 font-medium">Enrolled Learners</p>
                    </div>
                    <div className="space-y-1 pt-6 md:pt-0">
                        <span className="block text-3xl sm:text-5xl font-black text-purple-400">25+</span>
                        <p className="text-xs sm:text-sm text-slate-300 font-medium">Modern Laboratories</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-6 sm:p-10 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs space-y-6">
                ...
                <Accordion type="single" collapsible className="w-full space-y-3" defaultValue="pillar-1">
                    <AccordionItem value="pillar-1" className="border border-slate-200 dark:border-slate-800 rounded-xl px-4">
                        ...
                        <AccordionContent className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed pt-1 pb-4">
                            We believe students learn best by doing. Through hands-on science experiments, community projects, and design-thinking workshops, learners apply theoretical knowledge to solve real problems.
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="pillar-2" className="border border-slate-200 dark:border-slate-800 rounded-xl px-4">
                        <AccordionTrigger className="hover:no-underline font-bold text-sm sm:text-base text-slate-800 dark:text-slate-200">
                            Continuous Assessment & Personalized Guidance
                        </AccordionTrigger>
                        <AccordionContent className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed pt-1 pb-4">
                            Rather than relying solely on high-stakes testing, our teachers employ formative feedback, diagnostic assessments, and 1-on-1 mentorship to cater to each student's unique learning pace.
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="pillar-3" className="border border-slate-200 dark:border-slate-800 rounded-xl px-4">
                        <AccordionTrigger className="hover:no-underline font-bold text-sm sm:text-base text-slate-800 dark:text-slate-200">
                            Global Perspectives & Digital Fluency
                        </AccordionTrigger>
                        <AccordionContent className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed pt-1 pb-4">
                            Digital literacy, ethical coding, cross-cultural studies, and foreign language programs equip our graduates to collaborate seamlessly on international stages.
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
            </div>
