...
const urlModuleMap: Record<string, { moduleKey: string; submenuName: string }> = {
  ...
  "/dashboard/communicate/send-notification": { moduleKey: "communicate", submenuName: "send_notification" },
  ...
  "/dashboard/communicate/notification-template": { moduleKey: "communicate", submenuName: "notification_template" },
